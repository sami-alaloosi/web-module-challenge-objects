...
function createMenuItem(name, cost, category) {
  let newMenuItme = {};
  newMenuItme.name = name;
  newMenuItme.price = cost;
  newMenuItme.category = category;
  return newMenuItme;
}
console.log(createMenuItem("Pizza", 15, "Lunch")) //this is a test.

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
const pizza = createMenuItem("Pizza", 15, "Lunch");
const coffee = createMenuItem("coffee", 5, "Drinks");
const water = createMenuItem("Watter", 1, "Drinks");
console.log(pizza, coffee, water) //this is a test.
...
function burgerDiscount(string) {
  if (string === "teacher" || string === "student") {
    return burger.discount = burger.price * 0.75;
  } else {
    return burger.discount = burger.price * 0.9;
  }
}
console.log(
  burgerDiscount("teacher"),
  burgerDiscount("student"),
  burgerDiscount("sami")
)//this is a test.
...
console.log(getLastReview(reviews));//this is a test.
...
function getReviewByRating(array, num) {
  ...
  for(let i = 0; i < array.length; i++) {
    if(array[i].rating > (num - 0.1) && array[i].rating <= (num + 0.9)) {
       rattingArray.push(array[i]);
    }
  }
  return rattingArray
}
console.log(getReviewByRating(reviews, 3))//this is a test.
